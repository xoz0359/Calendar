...
public class Mysub {
	...
	public void todaySubject() {
		...
		String[] subjectarr = {"java Application 개발을 위한 프로그래밍 기초", "java Application 개발 실무 프로젝트", "Web Application 개발을 위한 풀스택 개발 기술", "Web Application 개발 실무 프로젝트", "실무프로젝트를 위한 클라우드 서비스 기술", "AWS기반 데이터 활용 실무 프로젝트"};
		String[] subchgday = {"2025년 01월 22일", "2025년 02월 11일", "2025년 03월 26일", "2025년 04월 23일", "2025년 06월 9일", "2025년 7월 7일"};
